...
c.Cluster.controller_launcher_class = 'slurm'
c.Cluster.send_engines_connection_env = False
...
c.Cluster.controller_location = ex_ip

c.SlurmControllerLauncher.batch_template = """#!/bin/bash
...
#SBATCH --mem=4G
#SBATCH --time=2:00:00
#SBATCH -o slurm_controller.out

sh ~/launch_ecfers.sh
apptainer exec instance://container ~/launch_controller.sh
"""
...
#SBATCH --mem=4G
#SBATCH --time=2:00:00
#SBATCH -o slurm_engine.out

srun apptainer run /gscratch/cheme/dalba/ecfers_latest.sif ~/launch_engine.sh
"""
#------------------------------------------------------------------------------
...
#  Default: '/mmfs1/home/dalba/repos/ECFERS'
# c.BaseParallelApplication.work_dir = '/mmfs1/home/dalba/repos/ECFERS'
...
# c.IPClusterEngines.work_dir = '/mmfs1/home/dalba/repos/ECFERS'
...
## Set the working dir for the process.
#  See also: BaseParallelApplication.work_dir
# c.IPClusterStart.work_dir = '/mmfs1/home/dalba/repos/ECFERS'
...
#  Default: ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.controller']
# c.ControllerLauncher.controller_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.controller']
...
# c.BatchControllerLauncher.controller_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.HTCondorControllerLauncher.controller_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.LocalControllerLauncher.controller_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.LSFControllerLauncher.controller_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.MPIControllerLauncher.controller_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.PBSControllerLauncher.controller_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.SGEControllerLauncher.controller_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.SlurmControllerLauncher.controller_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.SSHControllerLauncher.controller_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.controller']
...
#  Default: ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
# c.EngineLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
...
# c.BatchEngineSetLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.HTCondorEngineSetLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.LocalEngineLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.LocalEngineSetLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.LSFEngineSetLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.MPIEngineSetLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.PBSEngineSetLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.SGEEngineSetLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.SlurmEngineSetLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.SSHEngineSetLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.SSHProxyEngineSetLauncher.engine_cmd = ['/opt/conda/envs/myenv/bin/python3.9', '-m', 'ipyparallel.engine']
